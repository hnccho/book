...
class MyWindow(PyQt5.QtWidgets.QMainWindow, form_class):
    ...
    def trade_stocks(self):
        ...
        for row_data in buy_list:
            ...
            if split_row_data[-1].rstrip() == '매수전':
                ...
                order_trade_stocks = True
                
        if order_trade_stocks is True:
    ...
    def load_buy_sell_list(self):
        ...
        for j in range(len(buy_list)):
            ...
            for i in range(len(split_row_data)):
                item = PyQt5.QtWidgets.QTableWidgetItem(split_row_data[i].rstrip())
    ...
    def check_balance(self):
        ...
        # balance
        item = PyQt5.QtWidgets.QTableWidgetItem(self.kiwoom.d2_deposit)
        item.setTextAlignment(Qt.AlignVCenter | Qt.AlignRight)
        self.tableWidget.setItem(0, 0, item)

        for i in range(1, 6):
            item = PyQt5.QtWidgets.QTableWidgetItem(self.kiwoom.opw00018_output['single'][i - 1])
            item.setTextAlignment(Qt.AlignVCenter | Qt.AlignRight)
        ...
        for j in range(item_count):
            ...
            for i in range(len(row)):
                item = PyQt5.QtWidgets.QTableWidgetItem(row[i])
                item.setTextAlignment(Qt.AlignVCenter | Qt.AlignRight)
